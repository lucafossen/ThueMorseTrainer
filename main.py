...
def main():
    ...
    active_color = Color(255, 165, 155)
    ...
    idle_color, border_color, border_width)
    left_indicator.color = dark_color
    left_indicator.border_color = dark_color
    ...
    screen_height/2-border_width/2+1),
    idle_color, border_color, border_width)
    right_indicator.color = dark_color
    right_indicator.border_color = dark_color
    ...
    idle_color, border_color, border_width)
    game_indicator.color = dark_color
    game_indicator.border_color = dark_color
